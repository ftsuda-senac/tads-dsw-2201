...
public class ExemploController {
    ...
    // http://localhost:8080/ex05?nome=Madonna&dataNascimento=1982-01-31&email=ftsuda@teste.com.br&senha=abcd1234
    @GetMapping("/ex05")
    ...
    // http://localhost:8080/ex06?nome=Madonna&dataNascimento=1982-01-31&email=ftsuda@teste.com.br&senha=abcd1234
    @GetMapping("/ex06")
    public ModelAndView exemplo06(
        ...
        DadosPessoais dados = new DadosPessoais(nome, dataNascimento, email, senha);
    ...
    public ModelAndView exemplo07() {
        ...
        DadosPessoais d1 = new DadosPessoais("Fulano da Silva", "2000-10-20", "fulano@teste.com.br", "abcd1234");
        lista.add(d1);
        DadosPessoais d2 = new DadosPessoais("Ciclana de Souza", "2001-05-20", "ciclana@teste.com.br", "abcd1234");
        lista.add(d2);
        DadosPessoais d3 = new DadosPessoais("Beltrano de Souza", "2002-03-24", "beltrano@teste.com.br", "123456");
        lista.add(d3);
    ...
    public ModelAndView exemplo08(@PathVariable("apelido") String apelido) {
        DadosPessoais dados = null;
        if ("fulano".equals(apelido)) {
            dados = new DadosPessoais("Fulano da Silva", "2000-10-20", "fulano@teste.com.br", "abcd1234");
        } else if ("ciclana".equals(apelido)) {
            dados = new DadosPessoais("Ciclana de Souza", "2001-05-20", "ciclana@teste.com.br", "abcd1234");
        } else if ("beltrano".equals(apelido)) {
            dados = new DadosPessoais("Beltrano de Souza", "2002-03-24", "beltrano@teste.com.br", "123456");
        }
    ...
    @GetMapping("/ex11")
    public String exemplo11Parte1(@RequestHeader("user-agent") String userAgent) {
        boolean mobile = userAgent.toLowerCase().contains("mobile");
        if (mobile) {
            return "redirect:/ex11-mobile";
        } else {
            return "redirect:/ex11-desktop";
        }
    }
